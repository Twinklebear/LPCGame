...
int LuaC::MathLib::magnitude(lua_State *l){
    //Stack: Vector2f
    Vector2f *v = Vector2fLib::checkVector2f(l, 1);
...
int LuaC::MathLib::toSceneSpace(lua_State *l){
    ...
    */
    ...
    if (LuaScriptLib::readType(l, 2) == rectfClass){
        ...
        Vector2fLib::PushVector2f(&transform, l);
    }
    else {
