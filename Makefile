...
OBJS=$(OBJPATH)math.o $(OBJPATH)timer.o $(OBJPATH)debugger.o $(OBJPATH)physics.o $(OBJPATH)image.o \
	...
	$(OBJPATH)uiobjectmanager.o $(OBJPATH)mapeditor.o $(OBJPATH)editorstate.o $(OBJPATH)gameobjecteditor.o
...
$(OBJPATH)gameobjecteditor.o: $(SRCPATH)gameobjecteditor.cpp
	$(CXX) -o $@ $^ $(CFLAGS)

$(OBJPATH)uiobjectmanager.o: $(SRCPATH)uiobjectmanager.cpp
	$(CXX) -o $@ $^ $(CFLAGS)
